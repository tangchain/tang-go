// Package network contains functions that deal with tang network passphrases
// and IDs.
package network
...
import (
	...
	"github.com/tang/go/hash"
	"github.com/tang/go/support/errors"
	"github.com/tang/go/xdr"
)

const (
	// PublicNetworkPassphrase is the pass phrase used for every transaction intended for the public tang network
	PublicNetworkPassphrase = "Public Global Tang Network ; September 2015"
...
// resulting hash is the value that can be signed by tang secret key to
// authorize the transaction identified by the hash to tang validators.
