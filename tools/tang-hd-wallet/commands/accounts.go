...
import (
	...
	"github.com/tang/go/exp/crypto/derivation"
...
var AccountsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		masterKey, err := derivation.DeriveForPath(derivation.TangAccountPrefix, seed)
		if err != nil {
		...
		for i := uint32(startID); i < startID+count; i++ {
			...
			println(fmt.Sprintf(derivation.TangAccountPathFormat, i), kp.Address(), kp.Seed())
		}
