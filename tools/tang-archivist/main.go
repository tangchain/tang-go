// Copyright 2016 Tang Development Foundation and contributors. Licensed
...
import (
	...
	"github.com/tang/go/tools/tang-archivist/internal"
)
...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "tang-archivist",
		Short: "inspect tang history archive",
