...
type AuthData struct {
	// The tang address of the customer that is initiating the send.
	Sender string `json:"sender" valid:"required,tang_address"`
...
type AuthResponse struct {
	...
	// (only present if info_status is ok) JSON of the recipient's AML information. in the Tang attachment convention
...
// Transaction represents transaction field in Tang attachment
...
// Operation represents a single operation object in Tang attachment
