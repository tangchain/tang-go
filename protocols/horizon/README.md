...
- [JS SDK 0.10.2](https://github.com/tang/js-tang-sdk/releases/tag/v0.10.2)
- [Java SDK 0.4.0](https://github.com/tang/java-tang-sdk/releases/tag/0.4.0)
...
* In ["Offers for Account"](https://www.tang.org/developers/horizon/reference/endpoints/offers-for-account.html),
`last_modified_time` field  endpoint can be `null` when ledger data is not available (has not been ingested yet).
* ["Trades for Offer"](https://www.tang.org/developers/horizon/reference/endpoints/trades-for-offer.html) endpoint
will query for trades that match the given offer on either side of trades, rather than just the "sell" offer.
Offer IDs are now [synthetic](https://www.tang.org/developers/horizon/reference/resources/trade.html#synthetic-offer-ids).
...
* In ["Trade Aggregations"](https://www.tang.org/developers/horizon/reference/endpoints/trade_aggregations.html) endpoint,
...
- [JS SDK 0.10.2](https://github.com/tang/js-tang-sdk/releases/tag/v0.10.2)
- [Java SDK 0.3.1](https://github.com/tang/java-tang-sdk/releases/tag/0.3.1)
...
- [JS SDK 0.8.2](https://github.com/tang/js-tang-sdk/releases/tag/v0.8.2)
- [Java SDK 0.2.1](https://github.com/tang/java-tang-sdk/releases/tag/0.2.1)
