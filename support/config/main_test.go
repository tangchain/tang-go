...
func TestAccountIDValidator(t *testing.T) {
	var val struct {
		Empty        string `valid:"tang_accountid"`
		NotSTRKey    string `valid:"tang_accountid"`
		NotAccountID string `valid:"tang_accountid"`
		Valid        string `valid:"tang_accountid"`
		WrongType    int    `valid:"tang_accountid"`
	}
...
func TestSeedValidator(t *testing.T) {
	var val struct {
		Empty     string `valid:"tang_seed"`
		NotSTRKey string `valid:"tang_seed"`
		NotSeed   string `valid:"tang_seed"`
		Valid     string `valid:"tang_seed"`
		WrongType int    `valid:"tang_seed"`
	}
