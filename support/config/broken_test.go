...
func TestOptionalTangFields(t *testing.T) {
	var val struct {
		F1 string `valid:"tang_accountid,optional"`
		F2 string `valid:"optional,tang_accountid"`
		F3 string `valid:"tang_seed,optional"`
		F4 string `valid:"optional,tang_accountid"`
	}
