...
func TestBuild(t *testing.T) {
	...
	RunSpecs(t, "Package: github.com/tang/go/build")
}

// ExampleTransactionBuilder creates and signs a simple transaction, and then
// encodes it into a base64 string capable of being submitted to tang-core.
//
...
// encodes the transaction into a base64 string capable of being submitted to tang-core. It uses
...
// being submitted to tang-core. It uses the transaction builder system.
func ExamplePayment() {
	seed := "SDOTALIMPAM2IV65IOZA7KZL7XWZI5BODFXTRVLIHLQZQCKK57PH5F3H"
	tx, err := Transaction(
		SourceAccount{seed},
