// Package federation provides a pluggable handler that satisfies the Tang
...
type Driver interface {
	...
	// federation request to lookup a `Record` using the provided tang address.
...
// conform to the Tang federation protocol.  This handler should be added to
...
type ReverseSQLDriver struct {
	...
	// tang account id to lookup, such as
