...
import (
	...
	"github.com/tang/go/support/db/dbtest"
...
func TestHandler(t *testing.T) {
    ...
    INSERT INTO people (id, name, domain) VALUES 
      ('GD2GJPL3UOK5LX7TWXOACK2ZPWPFSLBNKL3GTGH6BLBNISK4BGWMFBBG', 'scott', 'tang.org'),
      ('GCYMGWPZ6NC2U7SO6SMXOP5ZLXOEC5SYPKITDMVEONLCHFSCCQR2J4S3', 'bartek', 'tang.org');
  `)
	defer db.Close()
	...
	server.GET("/federation").
		...
		Status(http.StatusOK).
		JSON().Object().
		ContainsKey("tang_address").
		ValueEqual("tang_address", "scott*tang.org")
