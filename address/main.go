// Package address provides utility functions for working with tang
// addresses. See https://www.tang.org/developers/guides/concepts/federation.
// html#tang-addresses for more on addresses.
package address
