...
CREATE TABLE address_association (
  ...
  tang_public_key varchar(56) NOT NULL UNIQUE,
  created_at timestamp NOT NULL,
  PRIMARY KEY (chain, address_index, address, tang_public_key),
...
CREATE TABLE transactions_queue (
  ...
  /* ethereum: 100000000 in year 2128 + 7 decimal precision in Tang + dot */
  /* bitcoin:   21000000              + 7 decimal precision in Tang + dot */
  amount varchar(20) NOT NULL,
  tang_public_key varchar(56) NOT NULL,
  ...
  CONSTRAINT valid_tang_public_key CHECK (char_length(tang_public_key) = 56)
);
