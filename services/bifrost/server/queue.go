...
// validated transactions and sends it to TangAccountConfigurator for account configuration.
func (s *Server) poolTransactionsQueue() {
	...
	for {
		...
		go s.TangAccountConfigurator.ConfigureAccount(
			transaction.TangPublicKey,
