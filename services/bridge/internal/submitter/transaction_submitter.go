...
// TransactionSubmitter submits transactions to Tang Network
...
// LoadAccount loads current state of Tang account and creates a map entry if it didn't exist
...
// SubmitTransaction builds and submits transaction to Tang network
