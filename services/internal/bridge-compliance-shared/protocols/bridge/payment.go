...
import (
	...
	"github.com/tang/go/keypair"
	"github.com/tang/go/services/internal/bridge-compliance-shared/http/helpers"
	"github.com/tang/go/services/internal/bridge-compliance-shared/protocols"
	complianceServer "github.com/tang/go/services/internal/bridge-compliance-shared/protocols/compliance"
...
var (
	...
	PaymentCannotResolveDestination = &helpers.ErrorResponse{Code: "cannot_resolve_destination", Message: "Cannot resolve federated Tang address.", Status: http.StatusBadRequest}
...
type PaymentRequest struct {
	...
	Source string `form:"source" valid:"optional,tang_seed"`
	// Sender address (like alice*tang.org)
	Sender string `form:"sender" valid:"optional,tang_address"`
	// Destination address (like bob*tang.org)
	Destination string `form:"destination" valid:"optional,tang_destination"`
	// ForwardDestination
	...
	Amount string `form:"amount" valid:"required,tang_amount"`
	// Code of the asset destination should receive
	AssetCode string `form:"asset_code" valid:"optional,tang_asset_code"`
	// Issuer of the asset destination should receive
	AssetIssuer string `form:"asset_issuer" valid:"optional,tang_accountid"`
	// Only for path_payment
	SendMax string `form:"send_max" valid:"optional,tang_amount"`
	// Only for path_payment
	SendAssetCode string `form:"send_asset_code" valid:"optional,tang_asset_code"`
	// Only for path_payment
	SendAssetIssuer string `form:"send_asset_issuer" valid:"optional,tang_accountid"`
