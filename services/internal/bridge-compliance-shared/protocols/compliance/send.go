...
type SendRequest struct {
	...
	// Source account ID
	Source string `form:"source" valid:"required,tang_accountid"`
	// Sender address (like alice*tang.org)
	Sender string `form:"sender" valid:"required,tang_address"`
	// Destination address (like bob*tang.org)
	Destination string `form:"destination" valid:"required,tang_address"`
	// ForwardDestination
