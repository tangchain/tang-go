...
GOTOP="$( cd "$DIR/../../../../../../../.." && pwd )"
PACKAGES=$(find $GOTOP/src/github.com/tang/go/services/horizon/internal/test/scenarios -iname '*.rb' -not -name '_common_accounts.rb')
# PACKAGES=$(find $GOTOP/src/github.com/tang/go/services/horizon/internal/test/scenarios -iname 'kahuna.rb')

go install github.com/tang/go/services/horizon
...
go generate github.com/tang/go/services/horizon/internal/test/scenarios
# go test github.com/tang/go/services/horizon/internal/ingest
