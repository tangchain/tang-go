...
**Transactions** are the basic unit of change in the Tang Network.

A transaction is a grouping of [operations](./operation.md).

To learn more about the concept of transactions in the Tang network, take a look at the [Tang transactions concept guide](https://www.tang.org/developers/learn/concepts/transactions.html).
...
To submit a new transaction to Tang network, it must first be built and signed locally. Then you can submit a hex representation of your transaction’s [XDR](../../learn/xdr.md) to the `/transactions` endpoint. Read more about submitting transactions in [Post Transaction](../transactions-create.md) doc.
