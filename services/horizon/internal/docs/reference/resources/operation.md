...
[Operations](https://www.tang.org/developers/learn/concepts/operations.html) are objects that represent a desired change to the ledger: payments,
offers to exchange currency, changes made to account options, etc.  Operations
are submitted to the Tang network grouped in a [Transaction](./transaction.md).

To learn more about the concept of operations in the Tang network, take a look at the [Tang operations concept guide](https://www.tang.org/developers/learn/concepts/operations.html).

## Operation Types

| type                                          | type_i | description                                                                                                |
|-----------------------------------------------|--------|------------------------------------------------------------------------------------------------------------|
| [CREATE_ACCOUNT](#create-account)             | 0      | Creates a new account in Tang network.
| [PAYMENT](#payment)                           | 1      | Sends a simple payment between two accounts in Tang network.
| [PATH_PAYMENT](#path-payment)                 | 2      | Sends a path payment between two accounts in the Tang network.
| [MANAGE_OFFER](#manage-offer)                 | 3      | Creates, updates or deletes an offer in the Tang network.
...
offer to trade assets in the Tang network.
