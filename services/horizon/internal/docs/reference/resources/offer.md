...
Accounts on the Tang network can make [offers](http://tang.org/developers/learn/concepts/exchange.html) to buy or sell assets.  Users can create offers with the [Manage Offer](http://tang.org/developers/learn/concepts/list-of-operations.html) operation.
...
| selling     | [Asset](http://tang.org/developers/learn/concepts/assets.html)           | The Asset this offer wants to sell.                      |
| buying     | [Asset](http://tang.org/developers/learn/concepts/assets.html) | The Asset this offer wants to buy. |
