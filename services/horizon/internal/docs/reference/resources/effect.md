...
directly reflected in the [ledger](https://www.tang.org/developers/learn/concepts/ledger.html) or [history](https://github.com/tang/tang-core/blob/master/docs/history.md), as [transactions](https://www.tang.org/developers/learn/concepts/transactions.html) and [operations](https://www.tang.org/developers/learn/concepts/operations.html) are.
