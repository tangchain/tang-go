...
**Assets** are the units that are traded on the Tang Network.

An asset consists of an type, code, and issuer.

To learn more about the concept of assets in the Tang network, take a look at the [Tang assets concept guide](https://www.tang.org/developers/guides/concepts/assets.html).
...
|--------------|---------------------------------------------------------------------------------------------------|------------------------------------------------------------
| toml  | `https://www.tang.org/.well-known/tang.toml`| Link to the TOML file for this issuer |
...
```json
{
  "_links": {
    "toml": {
      "href": "https://www.tang.org/.well-known/tang.toml"
    }
  },
