...
the Tang Network, especially in the core protocol.  The ledger, transactions, results,
history, and even the messages passed between computers running tang-core
...
The IDL files used for the Tang Network are available
[on GitHub](https://github.com/tang/tang-core/tree/master/src/xdr).
