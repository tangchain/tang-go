...
clientData:
  laboratoryUrl: https://www.tang.org/laboratory/#explorer?resource=effects&endpoint=for_account
---
...
This endpoint can also be used in [streaming](../streaming.md) mode so it is possible to use it to listen for new effects as transactions happen in the Tang network.
...
```sh
curl "https://horizon-testnet.tang.org/accounts/GA2HGBJIJKI6O4XEM7CZWY5PS6GKSXL6D34ERAJYQSPYA6X6AI7HYW36/effects"
```
