...
clientData:
  laboratoryUrl: https://www.tang.org/laboratory/#explorer?resource=transactions&endpoint=create
---

Posts a new [transaction](../resources/transaction.md) to the Tang Network.
...
Tang Network's ledger is a [complicated and asynchronous
process](https://www.tang.org/developers/learn/concepts/transactions.html#life-cycle).
To reduce the complexity, horizon manages these asynchronous processes for the
client and will wait to hear results from the Tang Network before returning
...
Information about [building transactions](https://www.tang.org/developers/js-tang-base/learn/building-transactions.html) in JavaScript.
...
curl -X POST \
  ...
  "https://horizon-testnet.tang.org/transactions"
```
