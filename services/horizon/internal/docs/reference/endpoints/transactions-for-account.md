...
clientData:
  laboratoryUrl: https://www.tang.org/laboratory/#explorer?resource=transactions&endpoint=for_account
---
...
This endpoint can also be used in [streaming](../streaming.md) mode so it is possible to use it to listen for new transactions that affect a given account as they get made in the Tang network.
...
```sh
curl "https://horizon-testnet.tang.org/accounts/GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ/transactions?limit=1"
```
