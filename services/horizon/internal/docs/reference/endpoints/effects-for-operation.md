...
clientData:
  laboratoryUrl: https://www.tang.org/laboratory/#explorer?resource=effects&endpoint=for_operation
---
...
```sh
curl "https://horizon-testnet.tang.org/operations/77309415424/effects"
```
