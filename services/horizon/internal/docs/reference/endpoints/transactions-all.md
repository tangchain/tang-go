...
clientData:
  laboratoryUrl: https://www.tang.org/laboratory/#explorer?resource=transactions&endpoint=all
---
...
This endpoint can also be used in [streaming](../streaming.md) mode. This makes it possible to use it to listen for new transactions as they get made in the Tang network.
...
curl "https://horizon-testnet.tang.org/transactions?limit=200&order=desc"
```
