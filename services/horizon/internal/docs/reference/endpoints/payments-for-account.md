...
clientData:
  laboratoryUrl: https://www.tang.org/laboratory/#explorer?resource=payments&endpoint=for_account
---
...
This endpoint can also be used in [streaming](../streaming.md) mode so it is possible to use it to listen for new payments to or from an account as they get made in the Tang network.
...
curl "https://horizon-testnet.tang.org/accounts/GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ/payments?limit=25&order=desc"
```
