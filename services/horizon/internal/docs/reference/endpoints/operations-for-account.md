...
clientData:
  laboratoryUrl: https://www.tang.org/laboratory/#explorer?resource=operations&endpoint=for_account
---
...
```sh
curl "https://horizon-testnet.tang.org/accounts/GA2HGBJIJKI6O4XEM7CZWY5PS6GKSXL6D34ERAJYQSPYA6X6AI7HYW36/operations"
```
