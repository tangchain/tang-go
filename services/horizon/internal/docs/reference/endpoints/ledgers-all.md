...
title: All Ledgers
clientData:
  laboratoryUrl: https://www.tang.org/laboratory/#explorer?resource=ledgers&endpoint=all
---

This endpoint represents all [ledgers](../resources/ledger.md).
This endpoint can also be used in [streaming](../streaming.md) mode so it is possible to use it to get notifications as ledgers are closed by the Tang network.
...
curl "https://horizon-testnet.tang.org/ledgers?limit=200&order=desc"
```
