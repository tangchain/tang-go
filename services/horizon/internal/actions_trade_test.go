...
import (
	...
	. "github.com/tang/go/services/horizon/internal/db2/history"
	. "github.com/tang/go/services/horizon/internal/test/trades"
...
func TestTradeActions_IndexRegressions(t *testing.T) {
	t.Run("Regression:  https://github.com/tang/go/services/horizon/internal/issues/318", func(t *testing.T) {
		ht := StartHTTPTest(t, "trades")
		defer ht.Finish()
	...
	t.Run("Regression for nil prices: https://github.com/tang/go/issues/357", func(t *testing.T) {
		ht := StartHTTPTest(t, "trades")
		defer ht.Finish()
...
// https://github.com/tang/go/issues/215
