...
// data produced by the connected tang-core database, transforms it and
...
// Cursor iterates through a tang core database's ledgers
type Cursor struct {
	...
	// CoreDB is the tang-core db that data is ingested from.
	CoreDB *db.Session
...
type System struct {
	...
	Network string
	// TangCoreURL is the http endpoint of the tang-core that data is being
	// ingested from.
	TangCoreURL string
...
// New initializes the ingester, causing it to begin polling the tang-core
