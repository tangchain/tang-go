...
account :source, Tang::KeyPair.from_seed("SANFNPZPA4LWBD3RPDSCJU63KCBU3OBFOM5FFBJCGIOCVIABMRTKBAU2")
...
account :dest, Tang::KeyPair.from_seed("SABP5P625YBETJV4BCEWQD674ED4FF4QVNBRL6TQCRODJUWBNJBMND5O")
...
# Asset Code Issued: USD
account :issuer, Tang::KeyPair.from_seed("SCCUFFUANIXJPAWBHDXZXY5D4GB32QPM6MOUWDD6PTYBLPE6JVYZFE76")
...
# Asset Code Issued: USD
account :another, Tang::KeyPair.from_seed("SAISD7SISIIW5YNQ7GY5727L6MOFS667K3LVIPYPPUBIPCRQUORFLQMN")
