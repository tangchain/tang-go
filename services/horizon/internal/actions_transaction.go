...
import (
	...
	"github.com/tang/go/services/horizon/internal/render/sse"
)
...
// TransactionCreateAction submits a transaction to the tang-core network
...
func (action *TransactionCreateAction) loadResource() {
	...
	case *txsub.FailedTransactionError:
		...
		action.Err = &problem.P{
			...
			Detail: "The transaction failed when submitted to the tang network. " +
				"The `extras.result_codes` field on this response contains further " +
				"details.  Descriptions of each code can be found at: " +
				"https://www.tang.org/developers/learn/concepts/list-of-operations.html",
