...
// be submitted to the backing tang-core process, as well as looking up the status
...
// Submitter represents the low-level "submit a transaction to tang-core"
// provider.
type Submitter interface {
	// Submit sends the provided transaction envelope to tang-core
