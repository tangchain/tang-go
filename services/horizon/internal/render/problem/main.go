...
import (
	...
	"github.com/tang/go/support/context/requestid"
...
var (
	...
	BeforeHistory = problem.P{
		...
		Detail: "This horizon instance is configured to only track a " +
			"portion of the tang network's latest history. This request " +
	...
	StaleHistory = problem.P{
		...
		Detail: "This horizon instance is configured to reject client requests " +
			...
			"behind the connected instance of tang-core.  If you operate this " +
