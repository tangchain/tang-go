// Package ledger provides useful utilities concerning ledgers within tang,
// specifically as a central location to store a cached snapshot of the state of
// both horizon's and tang-core's views of the ledger.  This package is
...
// State represents a snapshot of both horizon's and tang-core's view of the
// ledger.
type State struct {
