...
import (
	...
	"github.com/tang/go/services/horizon/internal/db2"
	...
	"github.com/tang/go/support/time"
...
// GetAddress retrieves a tang address.  It confirms the value loaded is a
// valid tang address, setting an invalid field error if it is not.
...
// GetAccountID retireves an xdr.AccountID by attempting to decode a tang
...
// the string at the provided name in accordance with the tang client
// conventions
