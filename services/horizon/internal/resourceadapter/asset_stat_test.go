...
import (
	...
	protocol "github.com/tang/go/protocols/horizon"
	"github.com/tang/go/services/horizon/internal/db2/assets"
...
func TestLargeAmount(t *testing.T) {
	row := assets.AssetStatsR{
		...
		NumAccounts: 429,
		Flags:       0,
		Toml:        "https://xim.com/.well-known/tang.toml",
	}
	...
	assert.Equal(t, "https://xim.com/.well-known/tang.toml", res.Links.Toml.Href)
}
