...
import (
	...
	"github.com/tang/go/services/friendbot/internal"
	"github.com/tang/go/support/app"
	"github.com/tang/go/support/config"
...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "friendbot",
		Short: "friendbot for the Tang Test Network",
		Long:  "client-facing api server for the friendbot service on the Tang Test Network",
		Run:   run,
	}
