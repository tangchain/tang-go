...
const (
	// TangAccountPrefix is a prefix for Tang key pairs derivation.
	TangAccountPrefix = "m/44'/148'"
	// TangPrimaryAccountPath is a derivation path of the primary account.
	TangPrimaryAccountPath = "m/44'/148'/0'"
	// TangAccountPathFormat is a path format used for Tang key pair
	// derivation as described in SEP-00XX. Use with `fmt.Sprintf` and `DeriveForPath`.
	TangAccountPathFormat = "m/44'/148'/%d'"
