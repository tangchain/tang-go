...
// the format used internally to tang-core.
//
// tang-core represents asset "amounts" as 64-bit integers, but to enable
// fractional units of an asset, horizon, the client-libraries and other built
// on top of tang-core use a convention, encoding amounts as a string of
...
// represented in tang-core as 1010010000.
package amount
...
// One is the value of one whole unit of currency. Tang uses 7 fixed digits
...
var (
	...
	// Note: {1,20} because the biggest amount you can use in Tang is:
...
// Parse parses the provided as a tang "amount", i.e. a 64-bit signed integer
...
// ParseInt64 parses the provided as a tang "amount", i.e. a 64-bit signed
...
// IntStringToAmount converts string integer value and converts it to tang
