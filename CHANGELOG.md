...
- network:  Added the `HashTransaction` helper func to get the hash of a transaction targeted to a specific tang network.
...
[Unreleased]: https://github.com/tang/go/commits/master